...
sed -i "s/<account-access-key>/<account-access-key>${ACCESS_KEY}/g" /${AGENT_HOME}/conf/controller-info.xml
echo " account-access-key: ${ACCESS_KEY}"
sed -i "s/<account-name>/<account-name>${ACCOUNT_NAME}/g" /${AGENT_HOME}/conf/controller-info.xml
echo " account-name: ${ACCOUNT_NAME}"
sed -i "s/<application-name>/<application-name>${APP_NAME}/g" /${AGENT_HOME}/conf/controller-info.xml
echo " application-name: ${APP_NAME}"
sed -i "s/<tier-name>/<tier-name>${TIER_NAME}/g" /${AGENT_HOME}/conf/controller-info.xml
echo " tier-name: ${TIER_NAME}"
sed -i "s/<node-name>/<node-name>${NODE_NAME}/g" /${AGENT_HOME}/conf/controller-info.xml
